...
M4 = plain(
    ...
    'kost är viktig.</p>'
    '<p style="background:#fdf4ff;border:1px solid #f5d0fe;border-radius:10px;padding:0.8rem 1rem;">'
...
<head>
  ...
  <style>
    :root {
      ...
      --listen-color: #86198f;
      --listen-border: #f5d0fe;
      --listen-hover-bg: #fdf4ff;
      --listen-deepen-color: #1e293b;
      --listen-deepen-border: #94a3b8;
      --listen-deepen-hover-bg: #f1f5f9;
    }

    main { font-size: 1.1em; max-width: 820px; margin: 0 auto; }

    .guide-intro {
      background: #fdf4ff; border: 1px solid #f5d0fe; border-left: 4px solid #86198f;
    ...
    .milestone > summary::before { content: "▸"; color: #86198f; transition: transform 0.15s ease; flex-shrink: 0; }
    .milestone[open] > summary::before { transform: rotate(90deg); }
    .m-num {
      background: #86198f; color: #fff; font-size: 0.78rem; font-weight: 700; padding: 0.2rem 0.6rem;
    ...
    .eq-arrow { color: #86198f; font-weight: 700; padding: 0 0.35rem; }
    .eq-note { font-size: 0.82em; color: #666; }

    .pill-btn { background:#fdf4ff; border:1px solid #f5d0fe; border-radius:999px; padding:0.4rem 1rem; font-size:0.95rem; font-weight:600; color:#86198f; cursor:pointer; min-height:44px; font-family:inherit; }
    .pill-btn:hover { background:#fae8ff; }
    .pill-btn[aria-pressed="true"] { background:#86198f; color:#fff; border-color:#86198f; }
    ...
    .m-body a:not(.cite):not(.n-label) { color: #86198f; }
    ...
    .references h2 { font-size:1rem; color:#86198f; margin:0 0 0.6rem; }
    .references ol { margin:0 0 0 1.3rem; }
    .references li { margin-bottom:0.4rem; }
    .references a { color:#86198f; text-decoration:underline; }
