...
AREA = "body.area-amne { --area:#4338ca; --area-strong:#3730a3; --area-soft:#eef2ff; --area-border:#c7d2fe; --area-hover:#e0e7ff; }"
...
<head>
  ...
  <style>
    ...
    .intro-box { background:#eef2ff; border:1px solid #c7d2fe; border-left:4px solid #3730a3; border-radius:10px; padding:1rem 1.1rem; margin-bottom:1.25rem; }
    ...
    .jump a { display:inline-block; padding:0.35rem 0.8rem; min-height:36px; border:1px solid #a5b4fc; border-radius:999px; background:#fff; color:#3730a3; text-decoration:none; font-size:0.9rem; }
    .jump a:hover { background:#e0e7ff; }
    .jump a:focus-visible { outline:3px solid #1d4ed8; outline-offset:2px; }
    .tier { margin:2rem 0 0.4rem; padding-bottom:0.3rem; border-bottom:2px solid #c7d2fe; font-size:1.4rem; color:#3730a3; }
    ...
    .next-steps a { display:block; padding:0.7rem 0.9rem; background:#eef2ff; border:1px solid #c7d2fe; border-radius:8px; text-decoration:none; color:#1a1a2e; font-size:0.95rem; }
    .next-steps a:hover { background:#e0e7ff; }
    .next-steps a:focus-visible { outline:3px solid #1d4ed8; outline-offset:2px; }
    .next-steps a .n-label { display:block; font-size:0.72rem; letter-spacing:1.4px; text-transform:uppercase; color:#3730a3; font-weight:700; margin-bottom:0.2rem; }
...
<body class="area-amne">
  ...
  <main>
    ...
    <section class="intro-box">
      ...
      <p class="lyft">Vill du träna på att känna igen utrustningen på foto? Spela <a href="./labbutrustning-spel.html">Labbutrustning: känn igen föremålen</a>.</p>
    ...
    <div class="next-steps">
      <a href="../faropiktogram.html"><span class="n-label">Öva</span>Faropiktogram</a>
      <a href="./laborationer.html"><span class="n-label">Prova</span>Laborationer</a>
...
def cards():
    return [
     ("../faropiktogram.html", "Faropiktogram", "Faropiktogram", "Lär dig känna igen de nio faropiktogrammen. Bilderna är de officiella, och det är formen som visar vad faran är.", "Öppna övningen"),
     ("./ovningsverktyg.html", "Dra och släpp", "Dra och släpp, sortera", "Tretton sorteringsövningar: säkerhet, olyckor, etikett, utrustning, undersökningens steg, variabler, egenskaper och kemins historia. Direkt besked med förklaring.", "Öppna övningarna"),
...
<head>
  ...
  <style>
    ...
    .resource-thumb { width: 100%; aspect-ratio: 16 / 10; border: 1px solid var(--area-border); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1.1rem; text-align: center; padding: 0.5rem; box-sizing: border-box; background: linear-gradient(135deg, #eef2ff, #c7d2fe); color: var(--area-strong); }
...
__CARDS__
    ...
    <section class="study-tips">
      <details>
        ...
        <ul>
          <li>Börja med <a href="../faropiktogram.html">faropiktogrammen</a> och <a href="./ovningsverktyg.html#ov-sakerhet">säkerhetsövningen</a>. De är det viktigaste innan du går in i kemisalen.</li>
          <li>Sorteringsövningarna är i två nivåer. Börja med Grund och gå vidare till Lär mer när du känner dig säker.</li>
          <li>Kom ihåg att skilja på <em>det du ser</em> (observation) och <em>det du tror</em> (tolkning).</li>
