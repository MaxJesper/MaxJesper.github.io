#!/usr/bin/env python3
"""Skriver kemi/kemi-som-amne/data/*.json från data_*.py. Kör efter bygg_studieguide.py."""
import os, re, json, sys
HERE = os.path.dirname(os.path.abspath(__file__)); sys.path.insert(0, HERE)
ROOT = os.path.abspath(os.path.join(HERE, "..", "..", ".."))
D = os.path.join(ROOT, "kemi", "kemi-som-amne", "data"); os.makedirs(D, exist_ok=True)
...
html = open(os.path.join(ROOT, "kemi", "kemi-som-amne", "studieguide.html"), encoding="utf-8").read()
first = {}
