...
<head>
  ...
  <style>
    ...
    #prog { font-weight:700; color:#86198f; }
    .jump { display:flex; flex-wrap:wrap; gap:0.4rem; margin:0.6rem 0 0; padding:0; list-style:none; }
    .jump a { display:inline-block; padding:0.35rem 0.8rem; min-height:36px; border:1px solid #f0abfc; border-radius:999px; background:#fff; color:#86198f; text-decoration:none; font-size:0.9rem; }
    .jump a:hover { background:#fae8ff; }
    .jump a:focus-visible { outline:3px solid #1d4ed8; outline-offset:2px; }
    .tier { margin:2rem 0 0.4rem; padding-bottom:0.3rem; border-bottom:2px solid #f5d0fe; font-size:1.4rem; color:#86198f; }
    ...
    .next-steps a { display:block; padding:0.7rem 0.9rem; background:#fdf4ff; border:1px solid #f5d0fe; border-radius:8px; text-decoration:none; color:#1a1a2e; font-size:0.95rem; }
    .next-steps a:hover { background:#fae8ff; }
    .next-steps a:focus-visible { outline:3px solid #1d4ed8; outline-offset:2px; }
    .next-steps a .n-label { display:block; font-size:0.72rem; letter-spacing:1.4px; text-transform:uppercase; color:#86198f; font-weight:700; margin-bottom:0.2rem; }
  </style>
</head>
...
<head>
  ...
  <style>
    ...
    .resource-thumb { width: 100%; aspect-ratio: 16 / 10; border: 1px solid var(--area-border); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1.1rem; text-align: center; padding: 0.5rem; box-sizing: border-box; background: linear-gradient(135deg, #fdf4ff, #f5d0fe); color: var(--area-strong); }
