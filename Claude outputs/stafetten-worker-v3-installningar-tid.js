...
export default {
  async fetch(request, env) {
    ...
    if (delar.length === 3 && delar[2] === "startaFraga" && request.method === "POST") {
      ...
      // svarstid (sekunder) är läraren-konfigurerad och skickas med varje fråga; 20s
      // om inget annat anges. Deadline räknas ut en gång här (server-tid) så att klienter
      // aldrig behöver lita på sin egen klocka.
      const svarstid = Number(body.svarstid) > 0 ? Number(body.svarstid) : 20;
