...
## Kemi som ämne – byggt 21 sep 2026 (första kemikapitlet: säkerhet, arbetssätt, egenskaper, historia)
...
**Kvarstår:** Jespers granskning av text/källor/bilder, språkgranskning, lyssna-mp3, klassrumstest. Fler labbfoton (t.ex. termometer, våg, kolvställ; fotonumren 8258, 8259, 8275 och 8282 saknas i Hämtade filer).
...
### Idé 24 – Kemi-hudsidan: uppstart, kemihistoria, faropiktogram, labbutrustning, säkerhetsintyg — DELVIS BYGGD (punkt 1 och 4 lyfta till kapitlet Kemi som ämne 21 sep 2026; punkt 2 och 3 klara; `kemi/index.html` byggs fortfarande inte om)
...
3. **Övning 2: Laboratorieutrustning** – samma spelidé; **Jesper tar foton** på utrustningen så fort han hinner. **KLART 21 sep 2026:** `kemi/kemi-som-amne/labbutrustning-spel.html` (31 föremål, se avsnittet Kemi som ämne ovan); länkad från kemi/index, larande-spel, studieguidens M6 och index.
